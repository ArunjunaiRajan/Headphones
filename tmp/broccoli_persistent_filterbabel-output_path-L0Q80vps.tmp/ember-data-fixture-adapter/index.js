define('ember-data-fixture-adapter/index', ['exports', 'ember-data', 'ember'], function (exports, _emberData, _ember) {
  'use strict';
  ...
  } || _ember['default'].EnumerableUtils.map;
  ...
  exports['default'] = _emberData['default'].Adapter.extend({
    ...
    */
    queryFixtures: function queryFixtures() /*fixtures, query, typeClass*/{
      _ember['default'].assert('Not implemented: You must override the DS.FixtureAdapter::queryFixtures method to support querying the fixture store.');
    },
    ...
    */
    find: function find(store, typeClass, id /*, snapshot*/) {
      ...
      _ember['default'].assert('Unable to find fixtures for model type ' + typeClass.toString() + '. If you\'re defining your fixtures using \'Model.FIXTURES = ...\'\', please change it to \'Model.reopenClass({ FIXTURES: ... })\'.', fixtures);

      if (fixtures) {
        fixture = _ember['default'].A(fixtures).findBy('id', id);
      }
    ...
    */
    findMany: function findMany(store, typeClass, ids /*, snapshots*/) {
      ...
      _ember['default'].assert('Unable to find fixtures for model type ' + typeClass.toString(), fixtures);
    ...
    */
    findFixtureById: function findFixtureById(fixtures, id) {
      return _ember['default'].A(fixtures).find(function (r) {
        return '' + get(r, 'id') === '' + id;
      });
    },
    ...
    simulateRemoteCall: function simulateRemoteCall(callback, context) {
      ...
      return new _ember['default'].RSVP.Promise(function (resolve) {
        ...
        if (get(adapter, 'simulateRemoteResponse')) {
          ...
          _ember['default'].run.later(null, resolve, value, get(adapter, 'latency'));
        } else {
